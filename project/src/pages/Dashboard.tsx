  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
        ...
        <button className="bg-gradient-to-r from-blue-500 to-violet-600 text-white px-4 lg:px-6 py-2 lg:py-3 rounded-lg hover:from-blue-600 hover:to-violet-700 transition-all duration-200 flex items-center space-x-2">
